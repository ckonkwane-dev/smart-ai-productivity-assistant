...
- ✅ **Smart Email Generator:** Generate professional emails with adjustable tones (Formal, Friendly, Persuasive).
...
- ✅ **AI Chatbot Interface:** An interactive AI workplace assistant for general queries.
